...
public class Panel : MonoBehaviour {
    ...
    public class Position {
        ...
        public Position (string name, TextAnchor myAnchor,
            TextAnchor parentAnchor) : this (name) {
    ...
    public Tweener SetPosition (Position p, bool animated) {
        ...
        if (animated) {
            Transition = anchor.MoveToAnchorPosition (p.myAnchor,
                p.parentAnchor, p.offset);
            return Transition;
        } else {
            anchor.SnapToAnchorPosition (p.myAnchor, p.parentAnchor,
                p.offset);
            return null;
        }
    }
